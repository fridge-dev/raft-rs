...
pub trait PersistentLocalState {
    fn store_term_if_increased(&mut self, new_term: u64) -> bool;
    fn store_vote_for_term_if_unvoted(&mut self, expected_term: u64, vote: String) -> bool;
    fn current_term(&self) -> u64;
    fn voted_for_current_term(&self) -> (u64, Option<&String>);
}
